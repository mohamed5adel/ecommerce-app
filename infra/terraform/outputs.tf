...
output "security_group_id_tf" {
  description = "ID of the security group"
  value       = aws_security_group.k3s.id
}

output "ecr_repository_url_tf" {
